...
// Source: github.com/iqbalalfikri/simple-bank/db/sqlc (interfaces: Store)
...
func (m *MockStore) DeleteTransfer(arg0 context.Context, arg1 int32) error {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetAccountForUpdate(arg0 context.Context, arg1 int32) (db.Account, error) {
	m.ctrl.T.Helper()
