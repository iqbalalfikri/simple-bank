...
mock:
	mockgen -package mockdb  -destination db/mock/store.go github.com/iqbalalfikri/simple-bank/db/sqlc Store
.PHONY: postgres createdb dropdb migrateup migratedown sqlc test migrateuptest migratedowntest server mock